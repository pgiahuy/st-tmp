...
# from course.models import User, Student, Course, CourseClass, ScheduleSlot, Room, Semester, Registration, CoursePrerequisite, SystemConfig, UserRole, Day, Session
#
#
#
